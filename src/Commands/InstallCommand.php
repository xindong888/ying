...
class InstallCommand extends Command
{
     ...
     * @var string
     */
    protected $description = '安装ying框架后台包';
    ...
    /**
     * Get the composer command for the environment. 获取composer命令工具
     *
     * @return string
     */
    ...
    /**
     * Execute the console command. 控制台
     *
    ...
    public function handle(Filesystem $filesystem)
    {
        ...
        if ($this->option('with-dummy')) {
            ...
            $tags = ['dummy_seeds', 'dummy_content', 'dummy_config', 'dummy_migrations', 'zh_CN'];
